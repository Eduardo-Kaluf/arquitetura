...
\begin{document}
    ...
    \begin{figure}[h]
      \captionsetup{labelformat=empty, skip=0pt}
      \caption{\textbf{Processador VLIW: Datapath}}
      \centering
      \noindent\hspace*{-3cm}\includegraphics[scale=0.4]{./datapaths/vliw/datapathVliw.png}
    \end{figure}
    ...
    \begin{table}[H]
      ...
      \begin{tabular}{{|c c|}}
        \hline
        \rowcolor{gray!50}
        \multicolumn{1}{|c}{\textbf{Operação}} & \multicolumn{1}{c|}{\textbf{MULT\_OPS}} \\ \hline
    ...
    É importante ressaltar que nenhum branch pode ser passado dentro do loop de repetição da instrução REP.
    ...
    \begin{table}[H]
      ...
      \begin{tabular}{{|c c|}}
        ...
        \rowcolor{gray!50}
        \multicolumn{1}{|c}{\textbf{Operação}} & \multicolumn{1}{c|}{\textbf{OP\_ULA}} \\ \hline
        \multicolumn{1}{|c}{\textbf{Inc-Ops}}  & \multicolumn{1}{c|}{\textbf{000}}     \\ \hline
        \multicolumn{1}{|c}{\textbf{Empty}}    & \multicolumn{1}{c|}{\textbf{001}}     \\ \hline
        \multicolumn{1}{|c}{\textbf{Movh}}     & \multicolumn{1}{c|}{\textbf{010}}     \\ \hline
        \multicolumn{1}{|c}{\textbf{Movl}}     & \multicolumn{1}{c|}{\textbf{011}}     \\ \hline
        \multicolumn{1}{|c}{\textbf{Add}}      & \multicolumn{1}{c|}{\textbf{100}}     \\ \hline
        \multicolumn{1}{|c}{\textbf{Sub}}      & \multicolumn{1}{c|}{\textbf{101}}     \\ \hline
        \multicolumn{1}{|c}{\textbf{And}}      & \multicolumn{1}{c|}{\textbf{110}}     \\ \hline
        \multicolumn{1}{|c}{\textbf{Empty}}    & \multicolumn{1}{c|}{\textbf{111}}     \\ \hline
      \end{tabular}
    \end{table}
    ...
    \captionsetup[lstlisting]{labelformat=empty}
    \renewcommand{\lstlistingname}{}
    \begin{lstlisting}[caption={Assembly Novo Para Teste}]
    ...
    v.movl 0
    v.movh -8
    v.add r2 r1 ;; Adiciona o endereco do Vetor A para R2
    ...
    v.sub r3 r1 ;; 
    v.movl 4    ;;
    v.add r3 r1 ;; Endereco do Vetor A + 4 * interecao atual
